...
public class BlockBoundHelper {
    ...
    public BlockBoundHelper(float xMin, float yMin, float zMin, float xMax, float yMax, float zMax) {
        this.xMin = xMin;
        this.yMin = yMin;
        this.zMin = zMin;
    ...
    public BlockBoundHelper copy() {
        return new BlockBoundHelper(xMin, yMin, zMin, xMax, yMax, zMax);
    }
}
